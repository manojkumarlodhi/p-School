...
export default function InstructorCreatePassword() {
    ...
    <div className="inauth-page">
      ...
      <div className="inauth-left-brand">
        ...
        <p className="inauth-brand-sub">
          Set a strong password to keep your instructor account secure.
        </p>
      </div>
      ...
      <div className="inauth-right">
        <div className="inauth-form-inner">
          ...
          <form onSubmit={e => { e.preventDefault(); navigate('/instructor/login'); }}>
            <div className="inauth-field">
              ...
              <div className="inauth-input-wrap">
                ...
                <button type="button" className="inauth-eye-btn"
            ...
            <button type="submit" className="inauth-btn" style={{ marginTop: 24 }}>
              Save Password
            </button>
          </form>
        </div>
