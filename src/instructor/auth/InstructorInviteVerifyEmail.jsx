...
export default function InstructorInviteVerifyEmail() {
    ...
    <div className="inauth-page">
      <div className="inauth-left-brand">
        ...
        <p className="inauth-brand-sub">
          Please verify that you are the invited instructor. Enter the OTP sent to your email.
        </p>
      </div>
      ...
      <div className="inauth-right">
        <div className="inauth-form-inner">
          ...
          <p className="inauth-form-sub">Please verify that you are the invited instructor.</p>

          <div style={{ fontSize:13.5, color:'#6b7280', marginBottom:20 }}>
            Verification code sent to:{' '}
            <span style={{ color:'#1ba8d5', fontWeight:600 }}>amrit@gmail.com</span>
          </div>

          <form onSubmit={e => { e.preventDefault(); navigate('/instructor/invite/create-password'); }}>
            <div className="inauth-field">
              <label className="inauth-label">Enter OTP</label>
