...
export default function InstructorLogin() {
  ...
  const [email, setEmail] = useState('instructor@school.com');
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      if (email === 'instructor@school.com' && password === 'teach123') {
        // Save user session
  ...
  return (
    <div className="inauth-page">
      ...
      <div className="inauth-left-brand">
        ...
        <h2 className="inauth-brand-title">P-School Instructor</h2>
        <p className="inauth-brand-sub">
          Manage your classes, assignments, and virtual labs all in one place.
        </p>
      ...
      <div className="inauth-right">
        <div className="inauth-form-inner">
          ...
          <div className="inauth-footer" style={{ marginTop: 16 }}>
            <button className="inauth-link" onClick={() => navigate('/instructor/choose-language')}>
              Create an account
            </button>
          </div>
