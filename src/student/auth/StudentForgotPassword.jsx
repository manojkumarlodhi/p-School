  ...
  return (
    <div className="inauth-page">
      <div className="inauth-left-brand">
        ...
        <p className="inauth-brand-sub">We'll send a verification code to your email to reset your password securely.</p>
      </div>
      <div className="inauth-right">
        <div className="inauth-form-inner">
          <button className="inauth-back-btn" onClick={() => navigate('/instructor')}><BackIcon /> Back</button>
          <h1 className="inauth-form-title">Reset your password</h1>
          <p className="inauth-form-sub">Enter your email and we'll send you a link to reset your password</p>
          <form onSubmit={e => { e.preventDefault(); navigate('/student/verify-otp'); }}>
          ...
          <div className="inauth-terms-footer"><a href="#">Terms &amp; Condition</a> &bull; <a href="#">Privacy policy</a></div>
        </div>
      </div>
    </div>
  );
