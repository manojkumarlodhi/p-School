...
import './instructorcourses.css'; /* reuse same empty-state styles */

function EmptyIllustration() {
  return (
    <svg width="260" height="220" viewBox="0 0 260 220" fill="none"
      xmlns="http://www.w3.org/2000/svg" className="empty-illustration">
      ...
      <text x="122" y="160" fontSize="28" fontWeight="800" fill="#fff"
        textAnchor="middle" fontFamily="system-ui, sans-serif">X</text>
    ...
    <div className="icrs-page">
      ...
      <div className="icrs-page-header">
        <div className="icrs-header-left">
          <button className="icrs-back-btn" onClick={() => navigate(-1)} aria-label="Back">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" strokeWidth={2.5} strokeLinecap="round">
              <path d="M19 12H5M12 5l-7 7 7 7" />
            </svg>
          </button>
          <h1 className="icrs-page-title">Instructor Revenue</h1>
        </div>
        <span className="icrs-breadcrumb">
          User Management &rsaquo; Instructors &rsaquo; Instructors Details &rsaquo; Revenue
        </span>
      </div>
